...
const workOrganizationSegments: Segment[] = [
  {
    ...
    type: 'toggle',
    options: [
      { id: 'corporation', label: '🏢 Korporacja', value: 'Korporacja' },
      { id: 'startup', label: '🚀 Startup/Scaleup', value: 'Startup/Scaleup' },
      { id: 'public', label: '🏛️ Instytucja publiczna', value: 'Instytucja publiczna' },
    ...
    description: 'Typ organizacji, w której chcesz pracować',
    code: 'ORG',
    valueMap: {
      'Korporacja': 'K',
      'Startup/Scaleup': 'S',
  ...
  },
  {
    ...
    type: 'select',
    options: [
      { id: 'onsite', label: '🏢 Stacjonarny', value: 'Stacjonarny' },
      { id: 'remote', label: '🏠 Zdalny', value: 'Zdalny' },
  ...
  },
  {
    ...
    code: 'OC',
    valueMap: {
      'Formalna/Hierarchiczna': 'F',
      'Umiarkowana/Zbalansowana': 'U',
      'Elastyczna/Płaska': 'E',
      'Kreatywna/Swobodna': 'K'
    },
    reverseValueMap: {
      'F': 'Formalna/Hierarchiczna',
      'U': 'Umiarkowana/Zbalansowana',
      'E': 'Elastyczna/Płaska',
      'K': 'Kreatywna/Swobodna'
    }
  },
  {
    id: 'office-space',
...
const locationMobilitySegments: Segment[] = [
  ...
  },
  {
    ...
    valueMap: {
      'Stała lokalizacja': 'F',
      'Ograniczona mobilność': 'L',
      'Regularna mobilność': 'R',
      'Pełna mobilność': 'P',
      'Nomadyzm cyfrowy': 'N'
    },
    reverseValueMap: {
      'F': 'Stała lokalizacja',
      'L': 'Ograniczona mobilność',
      'R': 'Regularna mobilność',
      'P': 'Pełna mobilność',
      'N': 'Nomadyzm cyfrowy'
    }
  },
  {
    ...
    valueMap: {
      'Brak podróży': 'N',
      'Sporadyczne podróże': 'R',
      'Regularne krajowe': 'D',
      'Regularne międzynarodowe': 'I',
      'Częste globalne': 'G'
    },
    reverseValueMap: {
      'N': 'Brak podróży',
      'R': 'Sporadyczne podróże',
      'D': 'Regularne krajowe',
      'I': 'Regularne międzynarodowe',
      'G': 'Częste globalne'
    }
  }
]
...
const collaborationRelationsSegments: Segment[] = [
  ...
  },
  {
    ...
    code: 'TWS',
    valueMap: {
      'LoneWolf/Niezależny': 'L',
      'TeamAnt/Kolaboratywny': 'T',
      'LeaderLion/Przywódczy': 'LL',
      'SocialWhale/Wspierający': 'S'
    },
    reverseValueMap: {
      'L': 'LoneWolf/Niezależny',
      'T': 'TeamAnt/Kolaboratywny',
      'LL': 'LeaderLion/Przywódczy',
      'S': 'SocialWhale/Wspierający'
    }
  },
  {
...
const timeAvailabilitySegments: Segment[] = [
  ...
  },
  {
    ...
    code: 'SC',
    valueMap: {
      'Stały i przewidywalny': 'F',
      'Cykliczny': 'C',
      'Dynamiczny i adaptacyjny': 'D',
      'Zorientowany projektowo': 'P'
    },
    reverseValueMap: {
      'F': 'Stały i przewidywalny',
      'C': 'Cykliczny',
      'D': 'Dynamiczny i adaptacyjny',
      'P': 'Zorientowany projektowo'
    }
  }
]
